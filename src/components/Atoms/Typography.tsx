interface StyleClassName {
  ...
  //   color?: "dark" | "base" | "light" | "primary" | "secondary" | "tertiary" | "white" | "black";
...
export const Typography: React.FC<TypographyProps> = ({ variant = "p", size, color, weight, className, children = "", ...props }) => {
  ...
  const sizeClassName = size ? sizesMapping[size] : sizesMapping[defaultSize || "base"];
  //   const colorClassName = color ? colorMapping[color] : colorMapping[defaultColor || "base"];
